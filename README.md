...
- Production : https://seatyrants.crzcommon.com
- Staging : https://staging.seatyrants.crzcommon.com
...
```bash
git clone git@github.com:corentin35000/SeaTyrants_WebSite_FrontEnd.git
```
